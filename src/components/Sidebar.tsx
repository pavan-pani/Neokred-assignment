...
import { HiDocumentDuplicate, HiOutlineChevronUp } from "react-icons/hi";
  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <div className="text-lg flex justify-between mt-4 lg:mt-0 font-bold p-4">
            <span>Neo UI </span>
          ...
          <div className="px-4 flex flex-col gap-2">
            ...
            <li className="block">Vinking People</li>
          </div>
        </div>
        <div>
          <div className="px-4">
      ...
      <ProfileSection show={showProfile} />
    </>
  );
};
